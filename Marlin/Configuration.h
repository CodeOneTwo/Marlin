...
#define CUSTOM_MACHINE_NAME "3D Printer One"
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 47.40
    #define DEFAULT_Ki 4.80
    #define DEFAULT_Kd 117.03
  #endif
#else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 40, 200, 47.4 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 37, -47, -1.2 }
